        ...
        <section className="user-info-section">
          ...
          >
            ...
            <form onSubmit={handleAddNominee} className="modal-form">
              ...
              <label>
                Phone Number
                <FaInfoCircle className="tooltip-icon" data-tooltip-id="tooltip-phone" data-tooltip-content="10-12 digit numeric phone number" />
                <input
                  type="tel"
                  required
              ...
              <label>
                Policy Document
                <FaInfoCircle className="tooltip-icon" data-tooltip-id="tooltip-doc" data-tooltip-content="Only PDF, JPG, or PNG allowed" />
                <input
                  type="file"
